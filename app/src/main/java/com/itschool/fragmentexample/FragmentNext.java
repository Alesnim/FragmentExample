...
public class FragmentNext extends Fragment {
    ...
    public static FragmentNext newInstance(String param1, String param2) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHandler = new Handler() {
            ...
            public void handleMessage(@NonNull Message msg) {
                ...
                Bitmap b = (Bitmap) msg.getData().getParcelable("image");
                Log.d("MyApp", "ImageSet");
                imageView.setImageBitmap(b);
            }
        };


        new ImageDownloadTask(mHandler).execute();
    }
